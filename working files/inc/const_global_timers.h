...
#define INDEX_TIMER_TZNP1_NAZAD                                (INDEX_TIMER_TZNP1_VPERED + 1)
#define INDEX_TIMER_TZNP2_VPERED                               (INDEX_TIMER_TZNP1_NAZAD + 1)
#define INDEX_TIMER_TZNP2_NAZAD                                (INDEX_TIMER_TZNP2_VPERED + 1)
#define INDEX_TIMER_TZNP3_VPERED                               (INDEX_TIMER_TZNP2_NAZAD + 1)
#define INDEX_TIMER_TZNP3_NAZAD                                (INDEX_TIMER_TZNP3_VPERED + 1)
#define INDEX_TIMER_ZOP                                        (INDEX_TIMER_TZNP3_NAZAD + 1)
...
#define INDEX_TIMER_CHAPV2_1MS                                 (INDEX_TIMER_CHAPV1_1MS + 1)
#define INDEX_TIMER_BLOCK_CHAPV1_5MS                           (INDEX_TIMER_CHAPV2_1MS + 1)
#define INDEX_TIMER_BLOCK_CHAPV2_5MS                           (INDEX_TIMER_BLOCK_CHAPV1_5MS + 1)
