...
void check_current_index_is_presented_in_configuration(unsigned int*, int*, int, int, int, int, int, int, int, int, int, int, int, int, int);
...
void digital_registrator(unsigned int*, unsigned int volatile*);
