...
#define MAX_LEVEL_MENU          (222 + NUMBER_INPUTS + NUMBER_OUTPUTS + NUMBER_LEDS + 5*NUMBER_DEFINED_FUNCTIONS + 7*NUMBER_DEFINED_TRIGGERS + NUMBER_DEFINED_AND*(1 + NUMBER_IN_AND) + NUMBER_DEFINED_BUTTONS)   //Максимальна кількість допустимих вікон у системі меню
