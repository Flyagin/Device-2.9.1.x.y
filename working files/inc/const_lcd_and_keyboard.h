...
#define MAX_LEVEL_MENU          (207 + NUMBER_INPUTS + NUMBER_OUTPUTS + NUMBER_LEDS + 5*NUMBER_DEFINED_FUNCTIONS + 7*NUMBER_DEFINED_TRIGGERS + NUMBER_DEFINED_BUTTONS)   //Максимальна кількість допустимих вікон у системі меню
