...
#define MAX_ROW_FOR_CHOSE_EXTRA_SETTINGS  6

#define INDEX_ML_CTREXTRA_SETTINGS_1_CTRL_PHASE_LINE     0          
#define CTR_EXTRA_SETTINGS_1_CTRL_PHASE_LINE             (1 << INDEX_ML_CTREXTRA_SETTINGS_1_CTRL_PHASE_LINE)   
#define INDEX_ML_CTREXTRA_SETTINGS_1_CTRL_READY_TU       1          
