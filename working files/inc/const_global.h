...
#define NUMBER_GENERAL_SIGNAL_FOR_RANG_BUTTON     8
...
RANG_OUTPUT_LED_DF_REG_BLOCK_VKL_VV = 0,
...
#define NUMBER_GENERAL_SIGNAL_FOR_RANG_OUTPUT_LED_DF_REG     29
...
#define NUMBER_EL_SIGNAL_FOR_RANG_OUTPUT_LED_DF_REG          68
...
#define NUMBER_TOTAL_SIGNAL_FOR_RANG_OUTPUT_LED_DF_REG       (                                                      \
                                                              ...
                                                              NUMBER_EL_SIGNAL_FOR_RANG_OUTPUT_LED_DF_REG           \
                                                             ) 
...
#define MASKA_FOR_INPUT_SIGNALS_0        (unsigned int)(                                \
    (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_VKL_VV - 0))                            /* 0*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_RESET_LEDS - 0))                              /* 1*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_RESET_RELES - 0))                             /* 2*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_MISCEVE_DYSTANCIJNE - 0))                     /* 3*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_STATE_VV - 0))                                /* 4*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_OTKL_VID_ZOVN_ZAHYSTIV - 0))                  /* 5*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_VKL_VV - 0))                                  /* 6*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_CTRL_VKL - 0))                                /* 7*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_OTKL_VV - 0))                                 /* 8*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_CTRL_OTKL - 0))                               /* 9*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_RESET_BLOCK_READY_TU_VID_ZAHYSTIV - 0))       /*27*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_MTZ1 - 0))                              /*29*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_MTZ2 - 0))                              /*30*/  \
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_USK_MTZ2 - 0))                          /*31*/  \
)
...
#define MASKA_FOR_INPUT_SIGNALS_2        (unsigned int)(                              \
    (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_MTZ04_1 - 64))                          /*68*/\
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_MTZ04_2 - 64))                          /*69*/\
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_USK_MTZ04_2 - 64))                      /*70*/\
  | (1 << (RANG_OUTPUT_LED_DF_REG_PUSK_ZDZ_VID_DV - 64))                        /*75*/\
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_NZZ - 64))                              /*77*/\
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP1 - 64))                            /*85*/\
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP2 - 64))                            /*95*/\
)
...
#define MASKA_FOR_INPUT_SIGNALS_3        (unsigned int)(                                \
  ...
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_ACHR2 - 96))                            /*123*/ \
)
    
#define MASKA_FOR_INPUT_SIGNALS_4        (unsigned int)(                                \
    (1 << (RANG_OUTPUT_LED_DF_REG_PUSK_UROV_VID_DV - 128))                      /*134*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_ZOP - 128))                             /*138*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_UMIN1 - 128))                           /*141*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_START_UMIN1 - 128))                           /*142*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_UMIN2 - 128))                           /*143*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_START_UMIN2 - 128))                           /*144*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_UMAX1 - 128))                           /*153*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_UMAX2 - 128))                           /*156*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DF1_IN - 128))                                /*159*/ \
)
...
#define MASKA_FOR_INPUT_SIGNALS_5        (unsigned int)(                                \
  ...
  | (1 << (RANG_OUTPUT_LED_DF_REG_DF6_IN - 160))                                /*169*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DF7_IN - 160))                                /*171*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DF8_IN - 160))                                /*173*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DT1_SET - 160))                               /*175*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DT1_RESET - 160))                             /*176*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DT2_SET - 160))                               /*178*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DT2_RESET - 160))                             /*179*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DT3_SET - 160))                               /*181*/ \
  | (1 << (RANG_OUTPUT_LED_DF_REG_DT3_RESET - 160))                             /*182*/ \
...
#define MASKA_MTZ_SIGNALS_1        (unsigned int)(                                     \
     (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_MTZ3 - 32))                            /* 32*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_MTZ4 - 32))                            /* 33*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_VPERED_MTZN1 - 32))                   /* 34*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_NAZAD_MTZN1 - 32))                    /* 35*/\
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_U_MTZPN1 - 32))                           /* 39*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZPN1 - 32))                             /* 40*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_MTZ1 - 32))                                  /* 41*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_VPERED_MTZN2 - 32))                   /* 42*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_NAZAD_MTZN2 - 32))                    /* 43*/\
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_U_MTZPN2 - 32))                           /* 47*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZPN2 - 32))                             /* 48*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_MTZ2 - 32))                                  /* 49*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_VPERED_MTZN3 - 32))                   /* 50*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_NAZAD_MTZN3 - 32))                    /* 51*/\
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_U_MTZPN3 - 32))                           /* 55*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZPN3 - 32))                             /* 56*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_MTZ3 - 32))                                  /* 57*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_VPERED_MTZN4 - 32))                   /* 58*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_NAZAD_MTZN4 - 32))                    /* 59*/\
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_U_MTZPN4 - 32))                           /* 63*/\
)
...
#define MASKA_ZDZ_SIGNALS_2        (unsigned int)(                                     \
     (1 << (RANG_OUTPUT_LED_DF_REG_PUSK_ZDZ_VID_DV - 64))                       /*75*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_ZDZ - 64))                                   /*76*/\
)
...
#define MASKA_NZZ_SIGNALS_2        (unsigned int)(                                    \
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_NZZ - 64))                            /*84*/\
)
...
#define MASKA_TZNP_SIGNALS_2       (unsigned int)(                                    \
     (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP1 - 64))                           /*85*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP1_VPERED - 64))                   /*86*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP1_NAZAD - 64))                    /*87*/\
...
#define MASKA_TZNP_SIGNALS_3       (unsigned int)(                                     \
     (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP2_VPERED - 96))                   /*96*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP2_NAZAD - 96))                    /*97*/\
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP3 - 96))                           /*105*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP3_VPERED - 96))                   /*106*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP3_NAZAD - 96))                    /*107*/\
...
#define MASKA_APV_SIGNALS_3        (unsigned int)(                                     \
     (1 << (RANG_OUTPUT_LED_DF_REG_STAT_BLK_APV - 96))                          /*115*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_APV1 - 96))                                  /*116*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_APV2 - 96))                                  /*117*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_APV3 - 96))                                  /*118*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_APV4 - 96))                                  /*119*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_APV_WORK - 96))                              /*120*/\
)
...
#define MASKA_ACHR_CHAPV_SIGNALS_3 (unsigned int)(                                     \
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_ACHR1 - 96))                           /*122*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_ACHR2 - 96))                           /*123*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_RAZR_CHAPV - 96))                            /*124*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_CHAPV1_VID_U - 96))                    /*125*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_CHAPV2_VID_U - 96))                    /*126*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_BLOCK_CHAPV_VID_U - 96))                     /*127*/\
)

#define MASKA_ACHR_CHAPV_SIGNALS_4 (unsigned int)(                                     \
     (1 << (RANG_OUTPUT_LED_DF_REG_PO_ACHR1 - 128))                             /*128*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_CHAPV1 - 128))                            /*129*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_ACHR_CHAPV1 - 128))                          /*130*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_ACHR2 - 128))                             /*131*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_CHAPV2 - 128))                            /*132*/\
...
#define MASKA_UMIN_SIGNALS_4       (unsigned int)(                                     \
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_UBLK_UMIN1 - 128))                        /*146*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_IBLK_UMIN1 - 128))                        /*147*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_UMIN1 - 128))                                /*148*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_UMIN2 - 128))                             /*149*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_UBLK_UMIN2 - 128))                        /*150*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_IBLK_UMIN2 - 128))                        /*151*/\
...
#define MASKA_TRIGGER_SIGNALES_5               (unsigned int)(                          \
     (1 << (RANG_OUTPUT_LED_DF_REG_DT1_OUT - 160))                              /*177*/ \
   | (1 << (RANG_OUTPUT_LED_DF_REG_DT2_OUT - 160))                              /*180*/ \
   | (1 << (RANG_OUTPUT_LED_DF_REG_DT3_OUT - 160))                              /*183*/ \
   | (1 << (RANG_OUTPUT_LED_DF_REG_DT4_OUT - 160))                              /*186*/ \
)     
...
#define MASKA_SIGNALES_FOR_LOCK_GROUP_PICKUP_0         (unsigned int)(                 \
     (1 << (RANG_OUTPUT_LED_DF_REG_WORK_BO - 0))                                /* 19*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_WORK_BV - 0))                                /* 20*/\
)
...
#define MASKA_SIGNALES_FOR_LOCK_GROUP_PICKUP_1         (unsigned int)(                 \
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZN1_VPERED - 32))                       /* 37*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZN1_NAZAD - 32))                        /* 38*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZPN1 - 32))                             /* 39*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_MTZ1 - 32))                                  /* 41*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZ2 - 32))                               /* 44*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZN2_VPERED - 32))                       /* 45*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZN2_NAZAD - 32))                        /* 46*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZPN2 - 32))                             /* 47*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_MTZ2 - 32))                                  /* 49*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZ3 - 32))                               /* 52*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZN3_VPERED - 32))                       /* 53*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZN3_NAZAD - 32))                        /* 54*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZPN3 - 32))                             /* 55*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_MTZ3 - 32))                                  /* 57*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZ4 - 32))                               /* 60*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZN4_VPERED - 32))                       /* 61*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZN4_NAZAD - 32))                        /* 62*/\
...
#define MASKA_SIGNALES_FOR_LOCK_GROUP_PICKUP_3         (unsigned int)(                 \
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_TZNP3_NAZAD - 96))                        /*113*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_TZNP3 - 96))                                 /*114*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_APV_WORK - 96))                              /*115*/\
)
...
#define MASKA_SIGNALES_FOR_LOCK_GROUP_PICKUP_4         (unsigned int)(                 \
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_ACHR_CHAPV1 - 128))                          /*130*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_ACHR2 - 128))                             /*131*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_ACHR_CHAPV2 - 128))                          /*132*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_UROV - 128))                              /*135*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_UROV1 - 128))                                /*136*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_UROV2 - 128))                                /*137*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_ZOP - 128))                               /*139*/\
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_UMAX1 - 128))                             /*154*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_UMAX1 - 128))                                /*155*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_UMAX2 - 128))                             /*156*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_UMAX2 - 128))                                /*158*/\
)
...
#define MASKA_INFO_SIGNALES_0                  (unsigned int)(                          \
     (1 << (RANG_OUTPUT_LED_DF_REG_STATE_VV - 0))                               /* 4*/  \
   | (1 << (RANG_OUTPUT_LED_DF_REG_DEFECT - 0))                                 /*14*/  \
   | (1 << (RANG_OUTPUT_LED_DF_REG_AVAR_DEFECT - 0))                            /*15*/  \
   | (1 << (RANG_OUTPUT_LED_DF_REG_WORK_A_REJESTRATOR - 0))                     /*16*/  \
   | (1 << (RANG_OUTPUT_LED_DF_REG_WORK_D_REJESTRATOR - 0))                     /*16*/  \
)     
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_0 (unsigned int)(                        \
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_VKL_VV - 0))                                 /*  6*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_OTKL_VV - 0))                                /*  8*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_VIDKL_VID_ZAKHYSTIV - 0))                    /* 16*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_WORK_BO - 0))                                /* 19*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_WORK_BV - 0))                                /* 20*/\
)  
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_2 (unsigned int)(                        \
   ...
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_MTZ04_2 - 64))                            /* 73*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_MTZ04_2 - 64))                               /* 74*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_NZZ - 64))                                /* 76*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_NZZ - 64))                                   /* 79*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_PO_3I0 - 64))                                /* 80*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_3I0 - 64))                                   /* 81*/\
   | (1 << (RANG_OUTPUT_LED_DF_REG_TZNP1 - 64))                                 /* 94*/\
