...
void make_ekran_vidkluchenja(void)
{
  ...
  {
    {"   МТЗ1", "   МТЗ2", "   МТЗ3", "   МТЗ4", "МТЗ04 1", "МТЗ04 2", "   ЗДЗ", "    3I0", "    3U0", "    НЗЗ", "  ТЗНП1", "  ТЗНП2", "  ТЗНП3", " АЧР от", "   АЧР1", "   АЧР2", "  УРОВ1", "  УРОВ2", "    ЗОП", " ЗНмин1", " ЗНмин2", "ЗНмакc1", "ЗНмакc2", "    ОВЗ", " Другие"},
    {"   МCЗ1", "   МCЗ2", "   МCЗ3", "   МCЗ4", "МCЗ04 1", "МCЗ04 2", "   ЗДЗ", "    3I0", "    3U0", "    НЗЗ", "  СЗНП1", "  СЗНП2", "  СЗНП3", " АЧР в.", "   АЧР1", "   АЧР2", "  ПРВВ1", "  ПРВВ2", "    ЗЗП", " ЗНмін1", " ЗНмін2", "ЗНмакc1", "ЗНмакc2", "    ВЗЗ", "   Інші"},
    {"   OCP1", "   OCP2", "   OCP3", "   OCP4", "OCP04 1", "OCP04 2", "   ЗДЗ", "    3I0", "    3U0", "    НЗЗ", "  ТЗНП1", "  ТЗНП2", "  ТЗНП3", " АЧР f.", "   АЧР1", "   АЧР2", "  CBFP1", "  CBFP2", "   NPSP", "  Umin1", "  Umin2", "  Umax1", "  Umax2", "    ОВЗ", "  Other"},
    {"   МТЗ1", "   МТЗ2", "   МТЗ3", "   МТЗ4", "МТЗ04 1", "МТЗ04 2", "   ЗДЗ", "    3I0", "    3U0", "    НЗЗ", "  ТЗНП1", "  ТЗНП2", "  ТЗНП3", " АЧР от", "   АЧР1", "   АЧР2", "  УРОВ1", "  УРОВ2", "    ЗОП", " ЗНмин1", " ЗНмин2", "ЗНмакc1", "ЗНмакc2", "    ОВЗ", " Другие"}
  };
