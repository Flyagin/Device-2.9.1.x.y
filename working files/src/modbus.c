...
void convert_order_list_function_to_gmm(unsigned int* input_array, unsigned short int* output_array)
{
  ...
  //ТЗНП
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP1        , (BIT_MA_BLOCK_TZNP1          - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP1_VPERED, (BIT_MA_PO_3I0_TZNP1_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP1_NAZAD , (BIT_MA_PO_3I0_TZNP1_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP1_VPERED, (BIT_MA_PO_3U0_TZNP1_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP1_NAZAD , (BIT_MA_PO_3U0_TZNP1_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_TZNP1_VPERED    , (BIT_MA_PO_TZNP1_VPERED      - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_TZNP1_NAZAD     , (BIT_MA_PO_TZNP1_NAZAD       - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP1_VPERED, (BIT_MA_SECTOR_TZNP1_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP1_NAZAD , (BIT_MA_SECTOR_TZNP1_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_TZNP1              , (BIT_MA_TZNP1                - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP2        , (BIT_MA_BLOCK_TZNP2          - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP2_VPERED, (BIT_MA_PO_3I0_TZNP2_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP2_NAZAD , (BIT_MA_PO_3I0_TZNP2_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP2_VPERED, (BIT_MA_PO_3U0_TZNP2_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP2_NAZAD , (BIT_MA_PO_3U0_TZNP2_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_TZNP2_VPERED    , (BIT_MA_PO_TZNP2_VPERED      - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_TZNP2_NAZAD     , (BIT_MA_PO_TZNP2_NAZAD       - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP2_VPERED, (BIT_MA_SECTOR_TZNP2_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP2_NAZAD , (BIT_MA_SECTOR_TZNP2_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_TZNP2              , (BIT_MA_TZNP2                - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP3        , (BIT_MA_BLOCK_TZNP3          - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP3_VPERED, (BIT_MA_PO_3I0_TZNP3_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP3_NAZAD , (BIT_MA_PO_3I0_TZNP3_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP3_VPERED, (BIT_MA_PO_3U0_TZNP3_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP3_NAZAD , (BIT_MA_PO_3U0_TZNP3_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_TZNP3_VPERED    , (BIT_MA_PO_TZNP3_VPERED      - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_PO_TZNP3_NAZAD     , (BIT_MA_PO_TZNP3_NAZAD       - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP3_VPERED, (BIT_MA_SECTOR_TZNP3_VPERED  - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP3_NAZAD , (BIT_MA_SECTOR_TZNP3_NAZAD   - BIT_MA_CURRENT_AF_BASE));
  _CONVERT_SIGNAL_TO_GMM(input_array, output_array, RANG_OUTPUT_LED_DF_REG_TZNP3              , (BIT_MA_TZNP3                - BIT_MA_CURRENT_AF_BASE));
...
unsigned int convert_order_list_oldr_to_gmm(unsigned int number, unsigned int number_position, unsigned int source)
{
  ...
  if (index_in_gmm == number_position)
  {
    ...
    case RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP1:
      {
        rezultat = BIT_MA_BLOCK_TZNP1;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP1_VPERED:
      {
        rezultat = BIT_MA_PO_3I0_TZNP1_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP1_NAZAD:
      {
        rezultat = BIT_MA_PO_3I0_TZNP1_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP1_VPERED:
      {
        rezultat = BIT_MA_PO_3U0_TZNP1_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP1_NAZAD:
      {
        rezultat = BIT_MA_PO_3U0_TZNP1_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_TZNP1_VPERED:
      {
        rezultat = BIT_MA_PO_TZNP1_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_TZNP1_NAZAD:
      {
        rezultat = BIT_MA_PO_TZNP1_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP1_VPERED:
      {
        rezultat = BIT_MA_SECTOR_TZNP1_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP1_NAZAD:
      {
        rezultat = BIT_MA_SECTOR_TZNP1_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_TZNP1:
      {
        rezultat = BIT_MA_TZNP1;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP2:
      {
        rezultat = BIT_MA_BLOCK_TZNP2;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP2_VPERED:
      {
        rezultat = BIT_MA_PO_3I0_TZNP2_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP2_NAZAD:
      {
        rezultat = BIT_MA_PO_3I0_TZNP2_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP2_VPERED:
      {
        rezultat = BIT_MA_PO_3U0_TZNP2_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP2_NAZAD:
      {
        rezultat = BIT_MA_PO_3U0_TZNP2_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_TZNP2_VPERED:
      {
        rezultat = BIT_MA_PO_TZNP2_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_TZNP2_NAZAD:
      {
        rezultat = BIT_MA_PO_TZNP2_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP2_VPERED:
      {
        rezultat = BIT_MA_SECTOR_TZNP2_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP2_NAZAD:
      {
        rezultat = BIT_MA_SECTOR_TZNP2_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_TZNP2:
      {
        rezultat = BIT_MA_TZNP2;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP3:
      {
        rezultat = BIT_MA_BLOCK_TZNP3;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP3_VPERED:
      {
        rezultat = BIT_MA_PO_3I0_TZNP3_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP3_NAZAD:
      {
        rezultat = BIT_MA_PO_3I0_TZNP3_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP3_VPERED:
      {
        rezultat = BIT_MA_PO_3U0_TZNP3_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP3_NAZAD:
      {
        rezultat = BIT_MA_PO_3U0_TZNP3_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_TZNP3_VPERED:
      {
        rezultat = BIT_MA_PO_TZNP3_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_PO_TZNP3_NAZAD:
      {
        rezultat = BIT_MA_PO_TZNP3_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP3_VPERED:
      {
        rezultat = BIT_MA_SECTOR_TZNP3_VPERED;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP3_NAZAD:
      {
        rezultat = BIT_MA_SECTOR_TZNP3_NAZAD;
        break;
      }
    case RANG_OUTPUT_LED_DF_REG_TZNP3:
      {
...
unsigned int save_new_rang_oldr_from_gmm(unsigned int number, unsigned int number_position, unsigned int source, unsigned short int data, unsigned int method_setting)
{
  ...
  if (data != 0)
  {
    ...
    case BIT_MA_BLOCK_TZNP1:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP1);
        break;
      }
    case BIT_MA_PO_3I0_TZNP1_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP1_VPERED);
        break;
      }
    case BIT_MA_PO_3I0_TZNP1_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP1_NAZAD);
        break;
      }
    case BIT_MA_PO_3U0_TZNP1_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP1_VPERED);
        break;
      }
    case BIT_MA_PO_3U0_TZNP1_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP1_NAZAD);
        break;
      }
    case BIT_MA_PO_TZNP1_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_TZNP1_VPERED);
        break;
      }
    case BIT_MA_PO_TZNP1_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_TZNP1_NAZAD);
        break;
      }
    case BIT_MA_SECTOR_TZNP1_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP1_VPERED);
        break;
      }
    case BIT_MA_SECTOR_TZNP1_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP1_NAZAD);
        break;
      }
    case BIT_MA_TZNP1:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_TZNP1);
        break;
      }
    case BIT_MA_BLOCK_TZNP2:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP2);
        break;
      }
    case BIT_MA_PO_3I0_TZNP2_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP2_VPERED);
        break;
      }
    case BIT_MA_PO_3I0_TZNP2_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP2_NAZAD);
        break;
      }
    case BIT_MA_PO_3U0_TZNP2_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP2_VPERED);
        break;
      }
    case BIT_MA_PO_3U0_TZNP2_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP2_NAZAD);
        break;
      }
    case BIT_MA_PO_TZNP2_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_TZNP2_VPERED);
        break;
      }
    case BIT_MA_PO_TZNP2_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_TZNP2_NAZAD);
        break;
      }
    case BIT_MA_SECTOR_TZNP2_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP2_VPERED);
        break;
      }
    case BIT_MA_SECTOR_TZNP2_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP2_NAZAD);
        break;
      }
    case BIT_MA_TZNP2:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_TZNP2);
        break;
      }
    case BIT_MA_BLOCK_TZNP3:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP3);
        break;
      }
    case BIT_MA_PO_3I0_TZNP3_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP3_VPERED);
        break;
      }
    case BIT_MA_PO_3I0_TZNP3_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3I0_TZNP3_NAZAD);
        break;
      }
    case BIT_MA_PO_3U0_TZNP3_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP3_VPERED);
        break;
      }
    case BIT_MA_PO_3U0_TZNP3_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_3U0_TZNP3_NAZAD);
        break;
      }
    case BIT_MA_PO_TZNP3_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_TZNP3_VPERED);
        break;
      }
    case BIT_MA_PO_TZNP3_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_PO_TZNP3_NAZAD);
        break;
      }
    case BIT_MA_SECTOR_TZNP3_VPERED:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP3_VPERED);
        break;
      }
    case BIT_MA_SECTOR_TZNP3_NAZAD:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_SECTOR_TZNP3_NAZAD);
        break;
      }
    case BIT_MA_TZNP3:
      {
        _SET_BIT(set_array_rang, RANG_OUTPUT_LED_DF_REG_TZNP3);
        break;
      }
    case BIT_MA_STAT_BLK_APV:
      {
