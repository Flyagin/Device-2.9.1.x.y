...
{
  _Bool previous_state_po_f1_achr = _CHECK_SET_BIT(active_functions, RANG_OUTPUT_LED_DF_REG_PO_ACHR);
  _Bool previous_state_po_f1_chapv = _CHECK_SET_BIT(active_functions, RANG_OUTPUT_LED_DF_REG_PO_CHAPV);
  ...
  if (!_GET_OUTPUT_STATE(tmp_value, 3))
  {
    ...
    if (previous_state_po_f1_achr) 
    {
      if (!po_f1_chapv_rab) 
      {
        ...
        _SET_BIT(activated_functions, RANG_OUTPUT_LED_DF_REG_PO_ACHR);
        po_f1_achr = 1;
      }
    }
    else
  ...
  do 
  {
    ...
    if (po_f1_chapv_tmp) 
    {
      _SET_BIT(activated_functions, RANG_OUTPUT_LED_DF_REG_PO_CHAPV);
    }
...
inline void apv_handler(unsigned int *activated_functions, unsigned int number_group_stp)
{
  ...
  //М:"ЧАПВ від ДВ"
  logic_APV_1 |= ((current_settings_prt.control_achr_chapv & CTR_CHAPV) != 0) << 22;
...
/*****************************************************/
inline void digital_registrator(unsigned int* carrent_active_functions, unsigned int volatile* previous_active_functions)
{
    ...
    else
    {
      ...
      if (_CHECK_SET_BIT(carrent_active_functions , RANG_OUTPUT_LED_DF_REG_BLOCK_CHAPV_VID_U) == 0)
      {
        ...
        else if (_CHECK_SET_BIT(carrent_active_functions , RANG_OUTPUT_LED_DF_REG_RAZR_CHAPV) != 0)
        {
          ...
          if (  
              (_CHECK_SET_BIT(previous_active_functions, RANG_OUTPUT_LED_DF_REG_ACHR_CHAPV  ) != 0) &&
              (_CHECK_SET_BIT(carrent_active_functions , RANG_OUTPUT_LED_DF_REG_ACHR_CHAPV  ) == 0)
             )   
          {
...
inline void main_protection(void)
{
  ...
  if (active_inputs !=0)
  {
      ...
      ) 
    {
      ...
      //Блок ТЗНП
      activated_functions[RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP1 >> 5] |= (_CHECK_SET_BIT(temp_value_for_activated_function_2, RANG_INPUT_BLOCK_TZNP1) != 0) << (RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP1 & 0x1f);
      activated_functions[RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP2 >> 5] |= (_CHECK_SET_BIT(temp_value_for_activated_function_2, RANG_INPUT_BLOCK_TZNP2) != 0) << (RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP2 & 0x1f);
      activated_functions[RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP3 >> 5] |= (_CHECK_SET_BIT(temp_value_for_activated_function_2, RANG_INPUT_BLOCK_TZNP3) != 0) << (RANG_OUTPUT_LED_DF_REG_BLOCK_TZNP3 & 0x1f);
  ...
  */ 
  ...
  if (_CHECK_SET_BIT(activated_functions, RANG_OUTPUT_LED_DF_REG_AVAR_DEFECT) == 0)
  {
    ...
    if ((current_settings_prt.configuration & (1 << TZNP_BIT_CONFIGURATION)) != 0)
    {
      tznp_handler(activated_functions, number_group_stp);
    }
    else
    {
  ...
  /**************************/
  digital_registrator(activated_functions, active_functions);
  /**************************/
